...
import { getAllProducts, getOwnedProducts, createProduct } from "../../services/productsService";
  ...
  useEffect(() => {
    const fetchExisting = async () => {
      try {
        ...
        const ownedProducts = await getOwnedProducts(roleData.user?.uid);
        setExistingProducts(ownedProducts);
      } catch (_) {
